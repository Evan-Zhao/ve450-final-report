...
\textcolor{gray}{\textit{Anno-Mage}\cite{annomage} is a light-weight
semi-automated annotation tool. It provides a simple and neat GUI with
differently colored suggestions. But the DNN models it supports are not
adequate for annotation for autonomous driving. It only supports 80 class
objects from the \textit{MS COCO} dataset using a pretrained RetinaNet mode.}
