...
A fully functional semi-automatic annotation tool is expected. It should provide flexible methods for easing the post inspection and correcting. Besides, it should provide the following functionalities:

% \subsubsection{Object detection}
% In terms of classes, we need to have bike, bus, car, motor, train, truck, rider, person, traffic light and traffic signs. 
